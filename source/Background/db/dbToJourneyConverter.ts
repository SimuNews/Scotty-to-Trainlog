...
export class DbToJourneyConverter {
        ...
        public convert(conId: number, response: DBahnResponse): Journey {
        ...
        private convertToLeg(abschnitt: VerbindungsAbschnitt): Leg {
            return {
                ...
                currency: "",
                notes: "",
                type: TrainlogTripType.TRAIN
            } as Leg;
        }

        private convertToTrainStation(station: Halt): TrainStation {
            return {
                name: station.name,
...
function convertIdToLocation(id: string): Location {
